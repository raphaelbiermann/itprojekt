...
This function uses a simple integral and linear regulator to control the AC unit. It\textquotesingle{}s basically a copy of the radiator function with inverted heat analysis in order to get a higher AC level in percentage when the temperature inside is higher than the setpoint. \mbox{\Hypertarget{_controller_8ino_aef8d57dbdb05a99caac118882b35d56c}\label{_controller_8ino_aef8d57dbdb05a99caac118882b35d56c}} 
...
The Heat Exchanger is useful when the outside temperature is desired inside the house This function uses the heat exchanger as a substitude to the air conditioner when the outside temperature is lower. \mbox{\Hypertarget{_controller_8ino_aa4542df6529eb717fdc0a3105fe8a6f2}\label{_controller_8ino_aa4542df6529eb717fdc0a3105fe8a6f2}} 
...
Heat exchanger amount (airflow) and heat exchanger transfer (heat) are set to the same level. \mbox{\Hypertarget{_controller_8ino_a3005755a1cc32c4a6537fc8c5c0fa3cb}\label{_controller_8ino_a3005755a1cc32c4a6537fc8c5c0fa3cb}} 
...
It will dispatch the C\+PU power between tasks which are expected to be executed in some regular intervals. Such intervals are often called sampling time. \mbox{\Hypertarget{_controller_8ino_a090aec666da0a428e48e596f9460a5ec}\label{_controller_8ino_a090aec666da0a428e48e596f9460a5ec}} 
...
Remember, each character at 9600 Baud requires about 1 msec. \mbox{\Hypertarget{_controller_8ino_a314881965417ddb0745f987c175471c3}\label{_controller_8ino_a314881965417ddb0745f987c175471c3}} 
...
I²C communication and keyboard input. \mbox{\Hypertarget{_controller_8ino_a70040c12b70c4183813492f54c34afc3}\label{_controller_8ino_a70040c12b70c4183813492f54c34afc3}} 
...
Use communication verbose flag (-\/v) to remove all but pure values. This allows to use the integrated Arduino serial plotter or an external software like gnuplot. \mbox{\Hypertarget{_controller_8ino_aa28090f2d59ec6e36525dd17cf21dc58}\label{_controller_8ino_aa28090f2d59ec6e36525dd17cf21dc58}} 
...
Works similar to a thermostat with a heat sensitive bending metal. Since the AC should not just turn on after the temperature rises above a certain level, we need a counter to give each unit a margin, in which it can operate without turning off. \mbox{\Hypertarget{_controller_8ino_a92c4579a209bbd8bc56592f8c2958895}\label{_controller_8ino_a92c4579a209bbd8bc56592f8c2958895}} 
